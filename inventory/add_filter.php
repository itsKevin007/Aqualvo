		...
		<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-plus-sign"></i> Add Inventory Filter</h2>												
					</div>
					
					<form class="form-horizontal" method="post" action="processAdd.php?action=add_filter" enctype="multipart/form-data" name="form" id="form">
					<div class="box-content">
							...
							<fieldset>
							  ...
							  <div class="control-group">
								...
								<div class="controls">
								  <input class="input-xlarge focused" id="ftype" name="ftype" type="text" autocomplete=off />
								  <div id="status"></div>
								</div>
							  </div>
							  ...
							  <div class="control-group">
								...
								<div class="controls">
								  <input class="input-xlarge focused" id="wsn" name="wsn" type="text" autocomplete=off />
								  <div id="status"></div>
								</div>
							  </div>
							  ...
							  <div class="control-group">
								...
								<div class="controls">
								  <input class="input-xlarge focused" id="purpose" name="purpose" type="text" autocomplete=off />
								  <div id="status"></div>
								</div>
							  </div>
