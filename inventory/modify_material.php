...
if (!defined('WEB_ROOT')) {
	...
	$sql = $conn->prepare("SELECT * FROM tr_inventory_material WHERE inv_id = '$id' AND is_deleted != '1'");
	$sql->execute();
	$sql_data = $sql->fetch();
		...
		<div class="row-fluid sortable">
				<div class="box span8">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-edit"></i> Modify Materials</h2>						
					</div>
					
					<form class="form-horizontal" method="post" enctype="multipart/form-data" action="process_material.php?action=modify">
