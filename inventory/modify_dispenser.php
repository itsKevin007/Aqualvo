...
if (!defined('WEB_ROOT')) {
	...
	$sql = $conn->prepare("SELECT * FROM tr_inventory_dispenser WHERE inv_id = '$id' AND is_deleted != '1'");
	$sql->execute();
	$sql_data = $sql->fetch();
		...
		<div class="row-fluid sortable">
				<div class="box span8">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-edit"></i> Modify Dispenser</h2>						
					</div>
					
					<form class="form-horizontal" method="post" enctype="multipart/form-data" action="process_dispenser.php?action=modify">
					<div class="box-content">
                            ...
                            <div class="control-group">
							  ...
							  <div class="control-group">
								...
								<div class="controls">
								  <input class="input-xlarge focused" id="serial" name="serial" type="text" value="<?php echo $sql_data['serial']; ?>" autocomplete=off />
								  <div id="status"></div>
								</div>
							  </div>
							  ...
							  <div class="control-group">
								<label class="control-label" for="focusedInput">Date Out</label>
								<div class="controls">
								  <input type="text" class="input-xlarge" id="txtFromDate7" name="date_out" value="<?php echo $sql_data['date_out']; ?>" onkeypress="return isNumberKey(event)" autocomplete=off />
								  <div id="status"></div>
								</div>
							  </div>
							  ...
							  <div class="control-group">
								...
								<div class="controls">
								  <input class="input-xlarge focused" id="wda_no" name="wda_no" type="text" value="<?php echo $sql_data['wda_no']; ?>" autocomplete=off />
								  <div id="status"></div>
								</div>
							  </div>
							  ...
							  <div class="control-group">
								...
								<div class="controls">
									<select name="cust_id" id="selectError" data-rel="chosen">
