		...
		<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-plus-sign"></i> Add Inventory Material</h2>												
					</div>
					
					<form class="form-horizontal" method="post" action="processAdd.php?action=add_material" enctype="multipart/form-data" name="form" id="form">
