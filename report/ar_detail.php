				...
				<div class="box span6">
					<div class="box-header well" data-original-title>
						...
						<tr>
							...
							<td><h2>Account Receivables Details - <?php echo $cust_label; ?></h2><h4><?php echo $wfrom; ?> to <?php echo $wto; ?></h4></td>
						</tr>
						</table></center>						
					</div>
					<br />
													...
													<td class="tddata" valign="top">
														...
														?>
																	<tr>
																		...
																		<td width="20px;">&nbsp;</td>
																		<td class="tddata" valign="top" width="50"><?php echo $lst_data['dr']; ?></td>
																		<td width="20px;">&nbsp;</td>
